...
define(["require", "exports", "../../lib/easelts/geom/Point", "../../lib/easelts/display/Container", "../util/ListUtil", "../../lib/easelts/animation/ImageSequence", "../controls/Loader", "../../lib/easelts/component/RectangleColor", "../../lib/easelts/util/MathUtil", "../../lib/easelts/display/SpriteSheet", "../../lib/easelts/display/Bitmap"], function (require, exports, Point_1, Container_1, ListUtil_1, ImageSequence_1, Loader_1, RectangleColor_1, MathUtil_1, SpriteSheet_1, Bitmap_1) {
    var FollowPointer1 = (function (_super) {
        __extends(FollowPointer1, _super);
        function FollowPointer1() {
            var _this = this;
        ...
        FollowPointer1.prototype.draw = function (ctx, ignore) {
        ...
        FollowPointer1.prototype.setStage = function (stage) {
            var _this = this;
        ...
        FollowPointer1.prototype.bindEvents = function () {
            var first = null;
            var dragging = false;
            var dx = 0;
            var dy = 0;
        };
        FollowPointer1.prototype.onTick = function (delta) {
        ...
        FollowPointer1.prototype.onResize = function (w, h) {
            _super.prototype.onResize.call(this, w, h);
            this.buffer.width = w;
            this.buffer.height = h;
        };
        return FollowPointer1;
    })(Container_1.default);
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = FollowPointer1;
});
